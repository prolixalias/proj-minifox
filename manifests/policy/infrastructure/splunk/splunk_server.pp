# Class: policy::infrastructure::splunk::splunk_server
# @summary Installs and configure Splunk Enterprise Server
#
# @example
#   include policy::infrastructure::splunk::splunk_server
#   
# @param [Optional[String] splunk_server
#   Specifies a Splunk server if not specified used Fact[fqdn]
#   setup to be referenced from another profile as `$policy::infrastructure::splunk::splunk_server::splunk_server_fqdn`
#   Default value: undef
# @param [String] hec_puppetsummary_token
#   xxx
# @param [String] hec_puppetdetailed_token
#   xxx
#

#
class minifox::policy::infrastructure::splunk::splunk_server (
